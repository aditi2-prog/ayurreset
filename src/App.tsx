...
const SectionTitle = ({ children, subtitle, light = false }: any) => (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="p-8 rounded-3xl border-2 border-[#2D4F1E] bg-white shadow-2xl relative flex flex-col transform md:scale-105 z-10">
            ...
            <Button className="w-full">Choose Guided Reset</Button>
          </div>
        </div>
      </div>
    </section>
...
const FAQ = () => {
  const faqs = [
    { q: "Will this actually work for me?", a: "Yes. Because it's personalized. We don't give you a generic diet; we identify your specific imbalance and give you the tools to fix it." },
...
const FinalCTA = () => (
  <section className="py-24 px-6 bg-[#2D4F1E] text-white text-center relative overflow-hidden">
    <div className="max-w-4xl mx-auto relative z-10">
      ...
      <Button variant="accent" className="mx-auto text-xl px-12 py-5">
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/80 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="text-2xl font-black text-[#2D4F1E] tracking-tighter">AYUR<span className="text-[#D4A373]">RESET</span></div>
        <div className="hidden md:flex items-center gap-8 font-semibold text-sm text-stone-600">
          <a href="#how-it-works" className="hover:text-[#2D4F1E]">How it Works</a>
          <a href="#pricing" className="hover:text-[#2D4F1E]">Pricing</a>
          <a href="#testimonials" className="hover:text-[#2D4F1E]">Reviews</a>
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <Button className="w-full shadow-2xl">
    ...
    <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-12">
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="#" className="hover:text-white">7-Day Reset</a></li>
          <li><a href="#" className="hover:text-white">Personalized Diagnosis</a></li>
          <li><a href="#" className="hover:text-white">Guided Transformation</a></li>
        </ul>
      </div>
      <div>
